...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed partial class UIComponent : GameFrameworkComponent
    {
        ...
        public int UIFormCount
        {
            get
            {
                return m_UIManager.UIFormCount;
            }
        }
        ...
        private void Start()
        {
            ...
            {
                m_InstanceRoot = new GameObject("UI Form Instances").AddComponent<RectTransform>();
        ...
        //     uiGroupHelper.gameObject.AddComponent<CanvasGroup>();
        //     transform.SetParent(p: m_InstanceRoot);
        //     transform.localScale = Vector3.one;
        ...
        {
            return m_UIManager.OpenUIForm(uiFormAssetName, order, DefaultPriority, false, null);
        }
        ...
        {
            return m_UIManager.OpenUIForm(uiFormAssetName, order, priority, false, null);
        }
        ...
        {
            return m_UIManager.OpenUIForm(uiFormAssetName, order, DefaultPriority, pauseCoveredUIForm, null);
        }
        ...
        {
            return m_UIManager.OpenUIForm(uiFormAssetName, order, DefaultPriority, false, userData);
        }
        ...
        {
            return m_UIManager.OpenUIForm(uiFormAssetName, order, priority, pauseCoveredUIForm, null);
        }
        ...
        {
            return m_UIManager.OpenUIForm(uiFormAssetName, order, priority, false, userData);
        }
        ...
        {
            return m_UIManager.OpenUIForm(uiFormAssetName, order, DefaultPriority, pauseCoveredUIForm, userData);
        }
        ...
        {
            return m_UIManager.OpenUIForm(uiFormAssetName, order, priority, pauseCoveredUIForm, userData);
        }
