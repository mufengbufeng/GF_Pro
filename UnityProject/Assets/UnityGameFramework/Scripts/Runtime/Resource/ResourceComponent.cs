...
namespace UnityGameFramework.Runtime
{
    ...
    public class ResourceComponent : GameFrameworkComponent
    {
            ...
            string customPackageName = "")
        {
            var package = string.IsNullOrEmpty(customPackageName)
                ? YooAssets.GetPackage(PackageName)
                : YooAssets.GetPackage(packageName: customPackageName);
            ...
            // else
            // {
            //     Log.Error($"UpdatePackageVersionAsync failed: {operation.Error}");
            //     return null;
            // }

            // return operation;
            // UpdatePackageManifestOperation updateOperation = package.UpdatePackageManifestAsync(packageVersion);
            // await updateOperation;
            // if (updateOperation.Status != EOperationStatus.Succeed) return null;
