...
namespace GameFramework.Resource
{
    internal partial class ResourceManager
    {
        ...
        private class FileStreamDecryption : IDecryptionServices
        {
            ...
            {
                var bundleStream = new BundleStream(fileInfo.FileLoadPath, FileMode.Open, FileAccess.Read, FileShare.Read);
                var createRequest = AssetBundle.LoadFromStreamAsync(bundleStream, fileInfo.FileLoadCRC, GetManagedReadBufferSize());
                return new DecryptResult
                {
                    Result = null,
        ...
        private class FileOffsetDecryption : IDecryptionServices
        {
            ...
            public DecryptResult LoadAssetBundleAsync(DecryptFileInfo fileInfo)
            {
                var createRequest = AssetBundle.LoadFromFileAsync(fileInfo.FileLoadPath, fileInfo.FileLoadCRC, GetFileOffset());
                return new DecryptResult
                {
                    Result = null,
                    CreateRequest = createRequest,
