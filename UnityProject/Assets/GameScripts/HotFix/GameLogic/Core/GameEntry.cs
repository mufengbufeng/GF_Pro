...
public partial class GameEntry : Singleton<GameEntry>
{
    ...
    {
        // GameModule.UI.OpenUIForm("LoadingStartUIFrom", "LoadingStartUIFrom");

        GameModule.UI.OpenUIForm("LoadingStartUIFrom" ,0);
    }
